...
positive_train_delete = get + "/positive_training.txt"
negative_train_delete = get + "/negative_training.txt"
if os.path.exists(positive_train_delete):
	os.remove(positive_train_delete)
if os.path.exists(negative_train_delete):
	os.remove(negative_train_delete)
